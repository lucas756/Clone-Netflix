const API_KEY = '49efa8f5e27e677dcfa453bade72a598';
...
export default {
        ...
        return [
            ...
            },
            {
                slug: 'trending',
                 ...
                 items: await basicFecth(`/movie/popular?api_key=${API_KEY}`)
            },
            {
                slug: 'toprated',
                title: 'Em alta',
    ...
    getMovieInfo: async(movieId, type) => {
        ...
        if(movieId){
           switch(type){
            case 'movie':
                info = basicFecth(`/movie/${movieId}?language=pt-BR&api_key=${API_KEY}`)
            break;
            case 'tv':
                info = basicFecth(`/tv/${movieId}?language=pt-BR&api_key=${API_KEY}`)
            break;
            default:
                info = null;
            break;    
